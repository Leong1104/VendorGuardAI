    ...
    <main className="mx-auto min-h-screen max-w-3xl space-y-8 p-8">
      ...
      {txn.explanation && (
        <section className="rounded-xl border border-zinc-200 p-5 dark:border-zinc-800">
          <h2 className="mb-2 text-lg font-medium">Why this was flagged</h2>
          <p className="whitespace-pre-line text-sm leading-relaxed text-zinc-700 dark:text-zinc-300">
            {txn.explanation}
          </p>
          <p className="mt-3 text-xs text-zinc-400">
            Narrative generated by AI from the deterministic findings below —
            it cannot add or re-score risks. Each finding cites its source
            documents.
          </p>
        </section>
      )}
      ...
      <section className="rounded-xl border border-zinc-200 p-5 dark:border-zinc-800">
        <h2 className="mb-3 text-lg font-medium">Analyst review</h2>
      ...
      <section>
        <h2 className="mb-3 text-lg font-medium">Audit trail</h2>
        <ul className="space-y-2">
          {(auditEvents ?? []).map((event) => (
            <li
              key={event.id}
              className="flex items-baseline gap-3 rounded-lg bg-zinc-50 px-4 py-2.5 text-sm dark:bg-zinc-900"
            >
          ...
          {(auditEvents ?? []).length === 0 && (
            <li className="text-sm text-zinc-500">No events recorded.</li>
          )}
        </ul>
      </section>
    </main>
